...
@ControllerAdvice
public class HandlerNoLibrarianFound {

    @ExceptionHandler(NoLibrarianFound.class)
    private ResponseEntity<RestErrorMessage> noLibrarianFound(NoLibrarianFound exception){
